...
public class LikedTimelineFragment extends TweetsListFragment {

    public static LikedTimelineFragment newInstance(User user) {
        LikedTimelineFragment likedTimelineFragment = new LikedTimelineFragment();
        Bundle args = new Bundle();
        args.putString("screenName", user.getScreenName());
        likedTimelineFragment.setArguments(args);
        return likedTimelineFragment;
    }
    ...
    void populateTimeline() {
        ...
        if (Network.isNetworkAvailable(activity) && Network.isOnline()) {
            ...
            client.getTweetsUserLiked(screenName, maxId, new JsonHttpResponseHandler() {
                @Override
